...
@Component
public class InvoicePdfAttachmentGenerator implements AttachmentGenerator {
    ...
    public InvoicePdfAttachmentGenerator(PurchaseContextPdfAttachmentSupport support,
